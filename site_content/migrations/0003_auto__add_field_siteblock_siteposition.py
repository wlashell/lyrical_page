...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'SiteBlock.siteposition'
        db.add_column('site_content_siteblock', 'siteposition', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['site_content.SitePosition'], null=True, blank=True), keep_default=False)

    def backwards(self, orm):
        
        # Deleting field 'SiteBlock.siteposition'
        db.delete_column('site_content_siteblock', 'siteposition_id')
