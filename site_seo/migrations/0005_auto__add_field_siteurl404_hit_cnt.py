...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SiteUrl404.hit_cnt'
        db.add_column('site_seo_siteurl404', 'hit_cnt',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SiteUrl404.hit_cnt'
        db.delete_column('site_seo_siteurl404', 'hit_cnt')
    ...
    models = {
        ...
        'site_seo.siteurl404': {
            ...
            'hit_cnt': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'site': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['sites.Site']"}),
