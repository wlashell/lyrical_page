...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('site_content_siteblock', 'siteposition',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['site_content.SitePosition'], null=True, blank=True),
                      keep_default=False)
