...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'SitePosition'
        db.create_table('site_content_siteposition', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('code', self.gf('django.db.models.fields.CharField')(unique=True, max_length=255)),
        ))
        db.send_create_signal('site_content', ['SitePosition'])

    def backwards(self, orm):
        
        # Deleting model 'SitePosition'
        db.delete_table('site_content_siteposition')
