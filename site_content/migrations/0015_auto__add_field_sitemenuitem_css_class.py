...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SiteMenuItem.css_class'
        db.add_column('site_content_sitemenuitem', 'css_class',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'SiteMenuItem.css_class'
        db.delete_column('site_content_sitemenuitem', 'css_class')
