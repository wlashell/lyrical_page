...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('site_content_sitepage', 'template',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['site_content.SitePageTemplateSelection'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SitePage.template'
        db.delete_column('site_content_sitepage', 'template_id')
