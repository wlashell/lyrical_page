...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'SitePage.enable_rte'
        db.add_column('site_content_sitepage', 'enable_rte', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)

    def backwards(self, orm):
        
        # Deleting field 'SitePage.enable_rte'
        db.delete_column('site_content_sitepage', 'enable_rte')
    ...
    models = {
        ...
        'site_content.sitepage': {
            ...
            'sitemenu_depth': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
