...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SitePosition.css_class'
        db.add_column('site_content_siteposition', 'css_class',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'SitePosition.css_class'
        db.delete_column('site_content_siteposition', 'css_class')
