...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'SiteUrl'
        db.create_table('site_seo_siteurl', (
        ...
        db.send_create_signal('site_seo', ['SiteUrl'])

        # Adding M2M table for field sitepages on 'SiteUrl'
        db.create_table('site_seo_siteurl_sitepages', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('siteurl', models.ForeignKey(orm['site_seo.siteurl'], null=False)),
            ('sitepage', models.ForeignKey(orm['site_content.sitepage'], null=False))
        ))
        db.create_unique('site_seo_siteurl_sitepages', ['siteurl_id', 'sitepage_id'])


    def backwards(self, orm):
        # Deleting model 'SiteUrl'
        db.delete_table('site_seo_siteurl')

        # Removing M2M table for field sitepages on 'SiteUrl'
        db.delete_table('site_seo_siteurl_sitepages')
