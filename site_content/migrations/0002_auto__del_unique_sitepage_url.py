...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Removing unique constraint on 'SitePage', fields ['url']
        db.delete_unique('site_content_sitepage', ['url'])
    
    
    def backwards(self, orm):
        
        # Adding unique constraint on 'SitePage', fields ['url']
        db.create_unique('site_content_sitepage', ['url'])
