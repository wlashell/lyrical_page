...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SiteBlock.enable_rte'
        db.add_column('site_content_siteblock', 'enable_rte',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'SiteBlock.enable_rte'
        db.delete_column('site_content_siteblock', 'enable_rte')
