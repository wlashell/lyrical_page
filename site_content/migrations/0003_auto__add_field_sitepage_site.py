...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'SitePage.site'
        db.add_column('site_content_sitepage', 'site', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['sites.Site']))
    
    
    def backwards(self, orm):
        
        # Deleting field 'SitePage.site'
        db.delete_column('site_content_sitepage', 'site_id')
